...
Each entry says what the paper does and, more to the point, where it meets the project — as a direct contribution, or as an input to one of the two axes above.
